$(document).ready(function(){
	...
	$("form").on("submit", function(event){
		...
		.done(function(data, status, respuesta){
				// console.info(data);
				$(".contenido").children("ol").prepend($("<li>" + "<strong>" + data.nombre + "</strong> - Idioma: " + data.idioma + "<small> - " + data.fecha.mday + "/" + data.fecha.mon + "/" + data.fecha.year + " " + data.fecha.hours + ":" + data.fecha.minutes + ":" + data.fecha.seconds + "</small><br />" + "<span>" + data.mensaje + "</span>" + "<br />" + data.acepto + "</li>"));
		})
