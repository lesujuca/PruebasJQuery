$(document).ready(function(){
	...
	/*Conceptos entre algunos métodos similares
		...
		append: Inserta contenido al final de un elemento, es decir continua en su misma fila de ser posible.
		...
		prepend: Insertar contenido, especificado por el parámetro, al principio de cada elemento; es decir coloca justo antes de la línea del elemento seleccionado.
